...
# Page look
use constant TITLE => 'Fundani board';	# Name of this image board
...
use constant TITLEIMG => '/content/img/Fundani-logo-small.png';			# Title image (point to a script file if rotating)
